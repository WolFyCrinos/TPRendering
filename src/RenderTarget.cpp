...
static GLenum attachment_type(InternalFormat_DepthStencil format)
{
    switch (format)
    {
    ...
    default: // default case added to prevent control reaching end of non-void function
        throw std::invalid_argument("Invalid format provided to attachment_type function");
    }
};
